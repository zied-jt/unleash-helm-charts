...
| image.repository | string | `"unleashorg/unleash-proxy"` |  |
| image.tag | string | `""` |  |
...
| proxy.apiToken | string | `"default:development.unleash-insecure-api-token"` |  |
| proxy.clientKeys[0] | string | `"proxy-client-key"` |  |
| proxy.serverHost | string | `"http://unleash:4242/api"` |  |
| replicaCount | int | `1` |  |
| resources | object | `{}` |  |
